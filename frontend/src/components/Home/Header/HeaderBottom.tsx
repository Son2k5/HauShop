    ...
    <div className="w-full bg-[#F5F5F3] relative">
      <div className="max-w-container mx-auto">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between w-full px-2 pb-4 lg:pb-0 h-full lg:h-24">
          ...
          >
            <Icon icon="heroicons-outline:bars-3" className="w-5 h-5" />
          ...
          <div className="relative w-full lg:w-[600px] h-[50px] text-base text-primeColor bg-white flex items-center gap-2 justify-between px-6 rounded-xl">
            ...
            <Icon icon="heroicons-outline:magnifying-glass" className="w-5 h-5" />
          ...
          <div className="flex gap-4 mt-3 lg:mt-0 items-center pr-6 cursor-pointer relative">
            ...
            {/* User */}
            <div onClick={() => setShowUser(!showUser)} className="flex gap-1">
              <Icon icon="heroicons-outline:user" className="w-5 h-5" />
            ...
            <Link to="/cart">
              <div className="relative">
                <Icon icon="heroicons-outline:shopping-cart" className="w-5 h-5" />
