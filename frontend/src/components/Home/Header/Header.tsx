        ...
        <Flex className="flex items-center justify-between h-full ">
          ...
          <div>
            ...
            <Bars3Icon
              ...
              className="inline-block md:hidden cursor-pointer w-8 h-6 top-6 right -4"
            />
            {sideNav && (
                ...
                >
                  <div className="w-full h-full bg-primeColor p-6">
                    ...
                    <ul className="text-gray-200 flex flex-col gap-2">
                      {navBarList.map((item) => (
                        <li
                          className="font-normal cursor-pointer hover:font-bold items-center text-lg text-gray-200 hover:underline underline-offset-[4px] decoration-[1px] hover:text-white md:border-r-[2px] border-r-gray-300 hoverEffect last:border-r-0"
                          key={item._id}
                        >
                          <NavLink
                            to={item.link}
