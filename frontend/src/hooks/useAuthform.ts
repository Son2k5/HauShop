...
export function useAuthForm<T extends Record<string, string>>({
        ...
        try {
            ...
            if (errorData?.errors) {
                ...
                for (const key in errorData.errors) {
                    ...
                    formattedErrors[key.toLowerCase()] = Array.isArray(messages) ? messages[0] : messages;
                }
    ...
    return { values, field, fieldErrors, serverError, loading, success, submit, reset, setValues };
}
