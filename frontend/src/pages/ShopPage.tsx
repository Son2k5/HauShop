        ...
        <aside className="hidden lg:block w-[240px] flex-shrink-0">
          <div className="sticky top-20 space-y-8">
            ...
            {hasActiveFilter && (
              <button
                onClick={handleReset}
                className="w-full py-2.5 border border-gray-200 text-sm font-bodyFont text-lightText hover:border-red-400 hover:text-red-500 transition-all duration-200"
              >
                Xóa bộ lọc
              </button>
            )}
          ...
          <div className="flex items-center justify-between mb-7 pb-5 border-b border-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="text-sm border border-gray-200 px-3 py-2 outline-none font-bodyFont cursor-pointer focus:border-red-400 transition-colors bg-white"
              >
...
function FilterTag({ label, onRemove }: { label?: string; onRemove: () => void }) {
  ...
  return (
    <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-100 text-xs font-bodyFont text-primeColor border border-gray-200">
      {label}
