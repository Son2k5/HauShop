  ...
  return (
    <div className="min-h-screen bg-[#fff8f0] px-6 py-16 text-[#342110]">
      <div className="mx-auto max-w-2xl rounded-[32px] border border-[#f4d3ae] bg-white p-10 shadow-[0_30px_80px_rgba(231,146,24,0.08)]">
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#d97904]">
          Admin Access
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            to="/"
            className="rounded-full bg-[#f28c18] px-5 py-3 font-semibold text-white transition hover:bg-[#db7f16]"
          >
            Về trang chủ
          </Link>
          <Link
            to="/profile"
            className="rounded-full border border-[#edc79b] px-5 py-3 font-semibold text-[#7d4f1f] transition hover:bg-[#fff2e0]"
          >
            Xem hồ sơ
          </Link>
        </div>
